...
```html
<form name="myForm" action="javascript:(void);" method="POST" target="_blank" oninput="result.value = '欢迎来自' + nikenameIpt.value + '的' + levelIpt.value + '大神光临本网咖！'"	>
	<label>大区：</label>
	<input type="text" id="nikenameIpt"><br>

	<label>段位：</label>
	<input type="text" id="levelIpt"><br><br>

	<output name="result" for="nikenameIpt levelIpt">?</output>
</form>
```
